    ...
    <section className="relative h-[80vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 md:px-12">
        <div className="relative flex flex-col items-center">
          ...
          <h2 className="absolute top-[10%] md:top-[20%] text-4xl md:text-5xl font-bold uppercase font-island-moments text-[var(--gold)] leading-none z-10 drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)]">
            your
          </h2>
